...
var AppComponent = /** @class */ (function () {
    function AppComponent(store) {
        ...
        if (shoppingList)
            store.dispatch(new _shopping_list_store_shopping_list_actions__WEBPACK_IMPORTED_MODULE_3__["SetIngredients"](JSON.parse(shoppingList)));
        this.store.select('shoppingList').subscribe(function (result) {
...
/* harmony import */ var _store_app_reducers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./store/app.reducers */ "./src/app/store/app.reducers.ts");
/* harmony import */ var _ngrx_effects__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ngrx/effects */ "./node_modules/@ngrx/effects/@ngrx/effects.es5.js");
/* harmony import */ var _ngrx_router_store__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ngrx/router-store */ "./node_modules/@ngrx/router-store/@ngrx/router-store.es5.js");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["StoreModule"].forRoot(_store_app_reducers__WEBPACK_IMPORTED_MODULE_10__["reducers"]),
                _ngrx_effects__WEBPACK_IMPORTED_MODULE_11__["EffectsModule"].forRoot([_auth_store_auth_effects__WEBPACK_IMPORTED_MODULE_15__["AuthEffects"]]),
                _ngrx_router_store__WEBPACK_IMPORTED_MODULE_12__["StoreRouterConnectingModule"],
...
/*!**************************************************************!*\
  !*** ./src/app/shopping-list/store/shopping-list.actions.ts ***!
  \**************************************************************/
/*! exports provided: SET_INGREDIENTS, ADD_INGREDIENT, ADD_INGREDIENTS, UPDATE_INGREDIENT, DELETE_INGREDIENT, START_EDIT, STOP_EDIT, SetIngredients, AddIngredient, AddIngredients, UpdateIngredient, DeleteIngredient, StartEdit, StopEdit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SetIngredients = /** @class */ (function () {
    function SetIngredients(payload) {
        this.payload = payload;
        this.type = SET_INGREDIENTS;
    }
...
function shoppingListReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case _shopping_list_actions__WEBPACK_IMPORTED_MODULE_0__["SET_INGREDIENTS"]:
            return __assign({}, state, { ingredients: action.payload });
...
module.exports = __webpack_require__(/*! d:\Angular\07-ngrx-recipes-finished\src\main.ts */"./src/main.ts");
